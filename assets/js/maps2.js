...
/** initMap function is fired when the google map script is read in things-to-do.html */
function initMap() {
 ...
 * @param {Array} placeType - extracted from object in database
 */
...
document.getElementById("historic-sites").addEventListener('click', function () {
    dropMarkers(Object.keys(database));
	console.log("hello");
});
